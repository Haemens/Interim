      ...
      <table className="w-full">
        <thead className="bg-slate-50 border-b border-slate-200">
          <tr>
            ...
            <th className="text-left px-6 py-3 text-sm font-medium text-slate-600">Sector</th>
            <th className="text-center px-6 py-3 text-sm font-medium text-slate-600">Jobs</th>
            <th className="text-center px-6 py-3 text-sm font-medium text-slate-600">Requests</th>
            <th className="text-center px-6 py-3 text-sm font-medium text-slate-600">Shortlists</th>
            ...
            <tr key={client.id} className="hover:bg-slate-50">
              ...
              <td className="px-6 py-4">
                <div className="text-sm">
                  ...
                  <p className="text-slate-500">{client.contactEmail}</p>
                </div>
              </td>
              ...
              <td className="px-6 py-4 text-center">
                <span className={`text-sm font-medium ${client.openJobsCount > 0 ? "text-green-600" : "text-slate-400"}`}>
                  {client.openJobsCount}
                </span>
              </td>
              <td className="px-6 py-4 text-center">
                <span className={`text-sm font-medium ${client.activeJobRequestsCount > 0 ? "text-amber-600" : "text-slate-400"}`}>
