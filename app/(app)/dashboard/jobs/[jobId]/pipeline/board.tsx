...
const STATUS_COLORS: Record<ApplicationStatus, string> = {
  NEW: "bg-blue-50 text-blue-900 border-blue-200 dark:bg-blue-500/20 dark:text-blue-300 dark:border-blue-800",
  CONTACTED: "bg-amber-50 text-amber-900 border-amber-200 dark:bg-amber-500/20 dark:text-amber-300 dark:border-amber-800",
  QUALIFIED: "bg-purple-50 text-purple-900 border-purple-200 dark:bg-purple-500/20 dark:text-purple-300 dark:border-purple-800",
  PLACED: "bg-green-50 text-green-900 border-green-200 dark:bg-green-500/20 dark:text-green-300 dark:border-green-800",
  REJECTED: "bg-red-50 text-red-900 border-red-200 dark:bg-red-500/20 dark:text-red-300 dark:border-red-800",
};
