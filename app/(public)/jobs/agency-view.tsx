...
import { MapPin, FileText, Building, Euro, Search, ArrowRight, Briefcase, Users, Zap } from "lucide-react";
...
export async function AgencyView({ tenantSlug, searchParams }: AgencyViewProps) {
